...
module.exports = {
    data: new SlashCommandBuilder().setName("add-xp").setDescription("Add XP to a member.").setDescriptionLocalizations({
        ...
        try {
            ...
            fs.readFile(`Server/${interaction.guild.id.toString()}.json`, "utf8", async function (err,data) {
                ...
                const embed = new MessageEmbed()
                    .setTimestamp()
                    .setTitle("Add XP")
                    .setDescription(`You have added ${xp} XP to the user <@${member.id.toString()}>`)
                    .setColor("#5bc24e")
