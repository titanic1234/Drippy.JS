...
module.exports = {
    ...
    async execute(client, message) {
        fs.readFile(`Server/${message.message.member.guild.id.toString()}.json`, "utf8", async function (err, data) {
            ...
            json_data.memberjoin.infos.aktiviert = true;
            fs.writeFile(`Server/${message.message.member.guild.id.toString()}.json`, JSON.stringify(json_data), () => {});
            console.log(json_data.memberjoin.infos.aktiviert);

            const embed = new MessageEmbed()
                .setTitle("Set - Management - Member Join - Welcome Message - Activate")
                .setDescription("Welcome Message was successfully activated.")
                .setColor("#00ff04")
