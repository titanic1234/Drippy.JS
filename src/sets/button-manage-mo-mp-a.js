        ...
        try {
            await fs.readFile(`Server/${message.message.member.guild.id.toString()}.json`, "utf8", async function (err, data) {
                ...
                if (channels.length === 0) {
                    channels = ["There are no mod roles yet."];
                }
                const setManageEmbed = new MessageEmbed()
                    .setTitle("Settings - Management - Moderation - Mod Roles - Add")
                    ...
                    .setFields(
                        {
                            name: "These are all mod roles", value: "⠀\n" + channels.join("\n")
                        },
                        {
                            name: "\n\nINFO",
                ...
                while (cmd) {
                    ...
                    if (role === null && save_role != null) {
                        ...
                        json_data.moderation.roles_mod.push(save_role.id.toString());
