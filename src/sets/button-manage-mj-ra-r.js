        ...
        try {
            await fs.readFile(`Server/${message.message.member.guild.id.toString()}.json`, "utf8", async function (err, data) {
                ...
                const setManageEmbed = new MessageEmbed()
                    .setTitle("Settings - Management - Member Join - Auto Role Add - Remove")
                ...
                while (cmd) {
                    ...
                    if (role === null && save_role != null) {
                        ...
                        json_data.memberjoin.roles = json_data.memberjoin.roles.filter(object => {
            ...
            console.log("Error in Remove Auto Role: " + error.toString());
        }
    }
}